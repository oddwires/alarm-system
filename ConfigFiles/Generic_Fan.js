...
// here's a GENERIC fan device that we'll expose to HomeKit
var GENERIC_Fan01 = {
  powerOn: false,
  setPowerOn: function(on) { 
    console.log("Turning the Parm1 fan %s", on ? "on" : "off");
	if (on) {
            fs.writeFile("Parm3", function(err) {
...
var fanUUID01 = uuid.generate('hap-nodejs:accessories:fan01');

// This is the Accessory that we'll return to HAP-NodeJS that represents our GENERIC light.
var fan01 = exports.accessory = new Accessory('Parm1', fanUUID01);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
fan01.username = "Parm2";
fan01.pincode = "031-45-154";
fan01.displayName = "Parm1";
...
fan01
  .addService(Service.Fan, "Parm1") // services exposed to the user should have "names" like "GENERIC Fan" for us
  .getCharacteristic(Characteristic.On)
  .on('set', function(value, callback) {
    GENERIC_Fan01.setPowerOn(value);
